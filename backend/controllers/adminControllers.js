...
export const editBook = async (req, res) => {
    ...
    try{
        const editBook = await Books.findByIdAndUpdate(id, {title, author, summary, cover}, { returnDocument: 'after' })
...
export const editMember = async (req, res) => {
    ...
    try{
        const editMember = await Users.findByIdAndUpdate(id, {email}, { returnDocument: 'after' })
