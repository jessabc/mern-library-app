...
const EditBookModal = ({form, handleChange, editBook, handleCover, editModalOpen, setEditModalOpen}: Props) => (
  <Dialog.Root open={editModalOpen} onOpenChange={setEditModalOpen} >
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none overflow-auto">
        ...
        <div>
          <form onSubmit={editBook}   encType='multipart/form-data' className='flex flex-col gap-3' >
            ...
            <label className="block">
                ...
                <input type="file"  name='cover'
                          hidden
                          accept='.png, .jpg, .jpeg'
                          onChange={handleCover} className="block w-full text-sm text-gray-500
            ...
            <TextField id="title" label="Title" variant="outlined" type="text"
              name='title'
              value={form.title}
              onChange={handleChange} required />

            <TextField id="author" label="Author" variant="outlined" type="text"
              name='author'
              value={form.author}
              onChange={handleChange} required/>

            <TextField id="summary" label="Summary" variant="outlined" type="text"
              name='summary'
              value={form.summary}
            ...
            <div className="mt-[25px] flex justify-end" >
              ...
              <button type="submit" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm focus:ring-offset-gray-800">
                Submit
              </button>
